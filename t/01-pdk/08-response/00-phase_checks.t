...
=== TEST 4: verify phase checking for kong.response.exit and with no body, failing phases
--- http_config eval
qq{
    $t::Util::HttpConfig
...
=== TEST 5: verify phase checking for kong.response.exit, rewrite, with plain string
--- http_config eval
qq{
    $t::Util::HttpConfig
...
=== TEST 6: verify phase checking for kong.response.exit, rewrite, with tables
--- http_config eval
qq{
    $t::Util::HttpConfig
...
=== TEST 7: verify phase checking for kong.response.exit, rewrite, with no body
--- http_config eval
qq{
    $t::Util::HttpConfig
...
=== TEST 8: verify phase checking for kong.response.exit, access, with plain string
--- http_config eval
qq{
    $t::Util::HttpConfig
...
=== TEST 9: verify phase checking for kong.response.exit, access, with tables
--- http_config eval
qq{
    $t::Util::HttpConfig
...
=== TEST 10: verify phase checking for kong.response.exit, access, with no body
--- http_config eval
qq{
    $t::Util::HttpConfig
...
=== TEST 11: verify phase checking for kong.response.exit, admin_api, with plain string
--- http_config eval
qq{
    $t::Util::HttpConfig
...
=== TEST 12: verify phase checking for kong.response.exit, admin_api, with tables
--- http_config eval
qq{
    $t::Util::HttpConfig
...
=== TEST 13: verify phase checking for kong.response.exit, admin_api, with no body
--- http_config eval
qq{
    $t::Util::HttpConfig
